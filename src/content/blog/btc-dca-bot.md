...
**「とにかく手軽に積立したい」なら取引所の機能で十分**です。一方、「下落時に買い増し量を増やす」「複数銘柄を独自ルールで」といった細かい制御をしたい、あるいは開発の勉強を兼ねたいなら、自作ボットの出番です。

取引所内蔵ボットで何ができて何ができないのかは、[取引所の自動売買ボット機能まとめ](/blog/exchange-builtin-bots/)で詳しく比較しています。以下では自作する方法を解説します。
